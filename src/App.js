...
function fetchData(page) {
  const promise = fetch(
    `https://api.odcloud.kr/api/15103788/v1/uddi:76f2c2e9-994a-4d60-9338-e9c7bcf85caa?page=${page}&perPage=20&serviceKey=DKyYe3Av8RY9B8zdwJFttIlmUMMsFSnDAJrKkORKfY%2BD6hGPSLv4lnbsZI2NOayheSc%2B7PpO4P3XIOFUPArSxw%3D%3D`
  ).then((res) => {
    if (!res.ok) {
      throw res;
    }
      ...
      >
        ...
        <div className="container">
          ...
          >
            ...
            <div className="buttons" style={{ height: "40px" }}>
              <button
                onClick={() => {
                  if (page === 1) {
                    return;
  ...
  return (
    <>
      ...
      >
        ...
        >
          <img
            src="https://img.icons8.com/ios-filled/50/null/search--v1.png"
            style={{ width: "20px" }}
          />
        </button>
      </form>
